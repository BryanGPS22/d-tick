            ...
            <div key={event.id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-2 mb-4">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  <span>{event.ticketsSold} / {event.totalTickets} sold • <span className="text-green-600 font-semibold">IDRX {event.revenue.toLocaleString()}</span></span>
                </div>
              </div>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2 border border-purple-600 text-purple-600 rounded-lg hover:bg-purple-50 transition-colors text-sm font-medium"
                >
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            <h2 className="text-sm font-medium text-gray-600 mb-2">Manage Event</h2>
          ...
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
                ...
                <div>
                  <h4 className="text-purple-600 font-semibold mb-4 border-l-4 border-purple-600 pl-3">
                    {event.title}
                  </h4>
                  <div className="space-y-3 ml-7">
                    {event.tiers.map((tier, index) => (
                      <div key={index} className="flex justify-between items-center">
                        <span className="text-sm text-purple-600 uppercase font-medium">
                          {tier.name}
                        </span>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
              <h3 className="text-lg font-bold text-gray-900 mb-6">Ticket Sales Performance</h3>
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-3 gap-6 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-3">Total sales</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-3">Per ticket</p>
                  </div>
                </div>

                <div>
                  <h4 className="text-base font-semibold text-gray-900 mb-4">Ticket Tier Performance</h4>
                        ...
                        <div className="flex justify-between items-center mb-2">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <span className={`text-sm font-semibold px-2 py-1 rounded ${
                              tier.percentage >= 80 ? 'bg-green-100 text-green-700' :
                              tier.percentage >= 60 ? 'bg-orange-100 text-orange-700' :
